    ...
    <div class="topbar">
        ...
        <div class="topbar-data">
            <div class="usr-act">
                ...
                <span>
                    <img src="{{ asset('assets/images/resource/topbar-usr1.jpg') }}" alt="" />
                    <i class="sts away"></i>
                </span>
                <div class="usr-inf">
                    <div class="usr-thmb brd-rd50">
                        <img class="brd-rd50" src="{{ asset('assets/images/resource/usr.jpg') }}" alt="" />
                        <i class="sts away"></i>
            ...
            <ul class="tobar-links">
                <li>
                    ...
                    <div class="nti-drp-wrp">
                        <h5 class="blue-bg">
                            <span>You Have</span> 7 Notifications
                        </h5>
                        <div class="nti-lst">
                            <div class="nti-usr">
                ...
                <li>
                    ...
                    <div class="nti-drp-wrp">
                        <h5 class="green-bg">
                            <span>You Have</span> 7 New Messages
                        </h5>
                        <div class="nti-lst">
                            <div class="nti-usr">
                                <img class="brd-rd50" src="{{ asset('assets/images/resource/acti-thmb2.jpg') }}"
                                    alt="" />
                                <div class="nti-usr-inr">
                                    <h5>
                                        <a href="#" title="">Sadi Orlaf</a>
                            ...
                            <div class="nti-usr">
                                <img class="brd-rd50" src="{{ asset('assets/images/resource/acti-thmb1.jpg') }}"
                                    alt="" />
                                <div class="nti-usr-inr">
                                    <h5>
                                        <a href="#" title="">Katti Smith</a>
                            ...
                            <div class="nti-usr">
                                <img class="brd-rd50" src="{{ asset('assets/images/resource/acti-thmb3.jpg') }}"
                                    alt="" />
                                <div class="nti-usr-inr">
                                    <h5>
                                        <a href="#" title="">Willimes Domson</a>
                            ...
                            <div class="nti-usr">
                                <img class="brd-rd50" src="{{ asset('assets/images/resource/acti-thmb4.jpg') }}"
                                    alt="" />
                                <div class="nti-usr-inr">
                                    <h5>
                                        <a href="#" title="">Holli Doe</a>
            ...
            <ul class="drp-sec">
                ...
                <li>
                    <a href="tables.html" title="">
                        <i class="ion-crop"></i> Funcionario</a>
                </li>
                <li>
