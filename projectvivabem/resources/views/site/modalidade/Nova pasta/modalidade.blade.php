                    ...
                    <div class="row gy-4 justify-content-center">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="pricing-card pricing-card_active">
                                ...
                                <div class="checklist">
                                    <ul>
                                        <li><i class="far fa-check-circle"></i>Todos os benefícios do plano "Gold".</li>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="pricing-card">
                                ...
                                <p class="pricing-card_content">O plano "Diamond" é a opção mais exclusiva, projetada para proporcionar uma experiência de academia de alto nível, com atenção personalizada e serviços premium.</p>
                                <div class="checklist">
                                    <ul>
